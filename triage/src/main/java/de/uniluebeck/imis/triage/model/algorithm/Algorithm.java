...
public abstract class Algorithm {
    ...
    // confirm states for the algorithm for the answers yes and no
     ...
     * @param createHistory
     */
    public abstract void showPreviousQuestionAndAnswer(int previousState, int newState,
    ...
    /**
     * This method is used to set the confirm states of the algorithm which are
    ...
    /**
     * Indicates that the answer to a question was yes and calls the confirm state
     */
    ...
    /**
     * Indicates that the answer to a question was no and calls the confirm state
     */
    ...
    /**
     * Sets the initial values for the text fields when states are changed
     *
     * @param i
     */
    public void setInitialValuesToFields(int i, TriageView triageView) {
        this.currentState = i;
        triageView.initView();
    }
